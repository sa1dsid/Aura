...
interface AuthRepository {
    ...
    suspend fun signUp(email: String, password: String): Result<EmailVerification>

    suspend fun confirmEmail(email: String, code: String): Result<AuthSession>

    suspend fun resendEmailCode(email: String): Result<Unit>
